# Boosting IT Audits with Intelligent Process Automation (IPA)
...
This project demonstrates a **Minimum Viable Product (MVP)** of an **Intelligent Process Automation (IPA)** solution to enhance the efficiency of IT audit workflows. The solution combines:
